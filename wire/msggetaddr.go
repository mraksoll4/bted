...
func (msg *MsgGetAddr) BteDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	return nil
}

// BteEncode encodes the receiver to w using the bitcoin protocol encoding.
// This is part of the Message interface implementation.
func (msg *MsgGetAddr) BteEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	return nil
}
