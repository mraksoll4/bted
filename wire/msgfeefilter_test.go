...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.BteEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.BteDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.BteEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.BteDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.BteEncode(w, test.pver, BaseEncoding)
		...
		err = msg.BteDecode(r, test.pver, BaseEncoding)
