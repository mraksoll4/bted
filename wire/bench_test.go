...
func BenchmarkDecodeGetHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BteEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetHeaders.BteEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
	...
	for i := 0; i < b.N; i++ {
		r.Seek(0, 0)
		msg.BteDecode(r, pver, LatestEncoding)
	}
}
...
func BenchmarkDecodeHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BteEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgHeaders.BteEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeGetBlocks(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BteEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetBlocks.BteEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeAddr(b *testing.B) {
	...
	// Serialize it so the bytes are available to test the decode below.
	var bb bytes.Buffer
	if err := ma.BteEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgAddr.BteEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeInv(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BteEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgInv.BteEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeNotFound(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BteEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgNotFound.BteEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeMerkleBlock(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.BteEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgMerkleBlock.BteEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
