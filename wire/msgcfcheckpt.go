...
func (msg *MsgCFCheckpt) BteDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
	// Read filter type
...
// This is part of the Message interface implementation.
func (msg *MsgCFCheckpt) BteEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
	// Write filter type
