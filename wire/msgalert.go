...
func (msg *MsgAlert) BteDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	var err error
...
// This is part of the Message interface implementation.
func (msg *MsgAlert) BteEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	var err error
	...
	if slen == 0 {
		return messageError("MsgAlert.BteEncode", "empty serialized payload")
	}
