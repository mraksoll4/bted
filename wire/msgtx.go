...
func (msg *MsgTx) BteEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
// the transaction.  This function differs from BteEncode in that BteEncode
...
func (msg *MsgTx) Serialize(w io.Writer) error {
	...
	//
	// Passing a encoding type of WitnessEncoding to BteEncode for MsgTx
