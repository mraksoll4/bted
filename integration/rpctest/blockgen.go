...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr bteutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*bteutil.Tx, error) {
...
func CreateBlock(prevBlock *bteutil.Block, inclusionTxs []*bteutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr bteutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*bteutil.Block, error) {
	...
	blockTxns := []*bteutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := bteutil.NewBlock(&block)
