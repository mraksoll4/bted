...
import (
	...
	"github.com/bitweb-project/bted/btcec/v2/schnorr"
	"github.com/bitweb-project/bted/bteutil"

	"github.com/bitweb-project/bted/btcec/v2/ecdsa"
...
// WitnessSignature creates an input witness stack for tx to spend BTE sent
...
// SignatureScript creates an input signature script for tx to spend BTE sent
...
func signMultiSig(tx *wire.MsgTx, idx int, subScript []byte, hashType SigHashType,
	addresses []bteutil.Address, nRequired int, kdb KeyDB) ([]byte, bool) {
...
func sign(chainParams *chaincfg.Params, tx *wire.MsgTx, idx int,
	...
	ScriptClass, []bteutil.Address, int, error) {
...
// versions.
func mergeMultiSig(tx *wire.MsgTx, idx int, addresses []bteutil.Address,
...
sigLoop:
	for _, sig := range possibleSigs {
		...
		for _, addr := range addresses {
			...
			// bad input.
			pkaddr := addr.(*bteutil.AddressPubKey)
...
func mergeScripts(chainParams *chaincfg.Params, tx *wire.MsgTx, idx int,
	pkScript []byte, class ScriptClass, addresses []bteutil.Address,
...
type KeyDB interface {
	GetKey(bteutil.Address) (*btcec.PrivateKey, bool, error)
}

// KeyClosure implements KeyDB with a closure.
type KeyClosure func(bteutil.Address) (*btcec.PrivateKey, bool, error)

// GetKey implements KeyDB by returning the result of calling the closure.
func (kc KeyClosure) GetKey(address bteutil.Address) (*btcec.PrivateKey, bool, error) {
	return kc(address)
}
...
type ScriptDB interface {
	GetScript(bteutil.Address) ([]byte, error)
}

// ScriptClosure implements ScriptDB with a closure.
type ScriptClosure func(bteutil.Address) ([]byte, error)

// GetScript implements ScriptDB by returning the result of calling the closure.
func (sc ScriptClosure) GetScript(address bteutil.Address) ([]byte, error) {
	return sc(address)
}
