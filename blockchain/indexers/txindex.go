...
func dbAddTxIndexEntries(dbTx database.Tx, block *bteutil.Block, blockID uint32) error {
...
func dbRemoveTxIndexEntries(dbTx database.Tx, block *bteutil.Block) error {
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) ConnectBlock(dbTx database.Tx, block *bteutil.Block,
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) DisconnectBlock(dbTx database.Tx, block *bteutil.Block,
	stxos []blockchain.SpentTxOut) error {
