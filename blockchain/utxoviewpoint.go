...
func (view *UtxoViewpoint) AddTxOut(tx *bteutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *bteutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *bteutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *bteutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *bteutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *bteutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *bteutil.Tx) (*UtxoViewpoint, error) {
