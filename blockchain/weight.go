...
func GetBlockWeight(blk *bteutil.Block) int64 {
...
func GetTransactionWeight(tx *bteutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *bteutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
