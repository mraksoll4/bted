...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*bteutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *bteutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *bteutil.Block) error {
