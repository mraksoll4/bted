...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*bteutil.Block, error) {
	...
	blocks := make([]*bteutil.Block, 0, 256)
	genesis := bteutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
