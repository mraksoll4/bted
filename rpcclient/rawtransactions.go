...
const (
	...
	defaultMaxFeeRate = bteutil.SatoshiPerBitcoin / 10
)
...
func (r FutureGetRawTransactionResult) Receive() (*bteutil.Tx, error) {
	...
	return bteutil.NewTx(&msgTx), nil
}
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*bteutil.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []btcjson.TransactionInput,
	amounts map[bteutil.Address]bteutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToBTE()
	}
...
func (c *Client) CreateRawTransaction(inputs []btcjson.TransactionInput,
	amounts map[bteutil.Address]bteutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsAsync(address bteutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(address bteutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address bteutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address bteutil.Address, skip,
