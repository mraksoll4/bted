...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []bteutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []bteutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee bteutil.Amount) FutureSetTxFeeResult {
	cmd := btcjson.NewSetTxFeeCmd(fee.ToBTE())
	return c.SendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee bteutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address bteutil.Address, amount bteutil.Amount) FutureSendToAddressResult {
	addr := address.EncodeAddress()
	cmd := btcjson.NewSendToAddressCmd(addr, amount.ToBTE(), nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SendToAddress(address bteutil.Address, amount bteutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address bteutil.Address,
	amount bteutil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := btcjson.NewSendToAddressCmd(addr, amount.ToBTE(), &comment,
		&commentTo)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address bteutil.Address, amount bteutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress bteutil.Address, amount bteutil.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := btcjson.NewSendFromCmd(fromAccount, addr, amount.ToBTE(), nil,
		nil, nil)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress bteutil.Address, amount bteutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress bteutil.Address, amount bteutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := btcjson.NewSendFromCmd(fromAccount, addr, amount.ToBTE(),
		&minConfirms, nil, nil)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress bteutil.Address, amount bteutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress bteutil.Address, amount bteutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress bteutil.Address,
	amount bteutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[bteutil.Address]bteutil.Amount) FutureSendManyResult {
	convertedAmounts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToBTE()
	}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[bteutil.Address]bteutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[bteutil.Address]bteutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[bteutil.Address]bteutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (bteutil.Address, error) {
	...
	return bteutil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []bteutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []bteutil.Address, account string) (bteutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []bteutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []bteutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (bteutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
// chain params.
func (c *Client) GetNewAddress(account string) (bteutil.Address, error) {
...
// chain params.
func (c *Client) GetNewAddressType(account, addrType string) (bteutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (bteutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (bteutil.Address, error) {
...
// transactions and NOT for normal use.
func (c *Client) GetRawChangeAddressType(account, addrType string) (bteutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (bteutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (bteutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (bteutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (bteutil.Address, error) {
...
func (c *Client) GetAccountAsync(address bteutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address bteutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address bteutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address bteutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]bteutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]bteutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = bteutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]bteutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount bteutil.Amount) FutureMoveResult {
	cmd := btcjson.NewMoveCmd(fromAccount, toAccount, amount.ToBTE(), nil,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) Move(fromAccount, toAccount string, amount bteutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount bteutil.Amount, minConfirms int) FutureMoveResult {

	cmd := btcjson.NewMoveCmd(fromAccount, toAccount, amount.ToBTE(),
		&minConfirms, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount bteutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount bteutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount bteutil.Amount,
...
func (c *Client) ValidateAddressAsync(address bteutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address bteutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]bteutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]bteutil.Amount)
	for k, v := range accounts {
		amount, err := bteutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]bteutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]bteutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (bteutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := bteutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the Response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (bteutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (bteutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (bteutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (bteutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (bteutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (bteutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (bteutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (bteutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (bteutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address bteutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address bteutil.Address) (bteutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address bteutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address bteutil.Address, minConfirms int) (bteutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address bteutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address bteutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address bteutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address bteutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*bteutil.WIF, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return bteutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address bteutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address bteutil.Address) (*bteutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *bteutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *bteutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *bteutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *bteutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *bteutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *bteutil.WIF, label string, rescan bool) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a bted chain server
...
// encryptwallet (Won't be supported by btewallet since it's always encrypted)
// listaddressgroupings (NYI in btewallet)
// listreceivedbyaccount (NYI in btewallet)
