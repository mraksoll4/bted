...
//
// NOTE: This is a btewallet extension.
...
// managed by btewallet are only written to disk with encrypted private keys,
...
//
// NOTE: This is a bted extension.
func (c *Client) ListAddressTransactionsAsync(addresses []bteutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a btewallet extension.
func (c *Client) ListAddressTransactions(addresses []bteutil.Address, account string) ([]btcjson.ListTransactionsResult, error) {
...
// used by btewallet to enable a wallet which does not have the private keys
