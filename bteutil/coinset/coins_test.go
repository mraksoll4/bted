...
func NewCoin(index int64, value bteutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 0.035BTE value.
	...
	testSimpleCoinTxValue0            = bteutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = bteutil.NewTxFromBytes(testSimpleCoinTxBytes)
