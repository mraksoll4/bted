...
// monetary amount.
const (
	AmountMegaBTE  AmountUnit = 6
	AmountKiloBTE  AmountUnit = 3
	AmountBTE      AmountUnit = 0
	AmountMilliBTE AmountUnit = -3
	AmountMicroBTE AmountUnit = -6
	AmountSatoshi  AmountUnit = -8
)

// String returns the unit as a string.  For recognized units, the SI
// prefix is used, or "Satoshi" for the base unit.  For all unrecognized
// units, "1eN BTE" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountSatoshi:
		return "Satoshi"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " BTE"
	}
}
...
//
// NewAmount is for specifically for converting BTE to Satoshi.
// For creating a new Amount with an int64 value which denotes a quantity of Satoshi,
// do a simple type conversion from type int64 to Amount.
// See GoDoc for example: http://godoc.org/github.com/btcsuite/bted/bteutil#example-Amount
...
// ToBTE is the equivalent of calling ToUnit with AmountBTE.
func (a Amount) ToBTE() float64 {
	return a.ToUnit(AmountBTE)
}
...
// String is the equivalent of calling Format with AmountBTE.
func (a Amount) String() string {
	return a.Format(AmountBTE)
}
