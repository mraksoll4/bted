...
// Tx returns a wrapped transaction (bteutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (bteutil.Tx) for all
...
// instead provides easy access to wrapped versions (bteutil.Tx) of them.
